...
### Кнопки
    ...
    badd = Button(window,  text="Add Word",
                  bg = "LightSkyBlue1", font = ("Time New Roman", 12, "bold"), command=addWord,width = 100, height = 2)#, bg = "green")
    badd.pack(fill = X, padx=15, pady=5)
    #badd.pack(fill=X)
    defin = Button(window,  text="Add Definition",
                   bg = "sky blue",font = ("Time New Roman", 12, "bold"),command=addDef,width = 100, height = 2)
    defin.pack(fill=X, padx=15, pady=5)
    bdel = Button(window,  text="Delete",
                  bg = "dark turquoise", font = ("Time New Roman", 12, "bold"),command=delList,width = 100, height = 2)
    bdel.pack(fill=X, padx=15, pady=5)
    bsave = Button(window,  text="Save",
                   bg = "cornflower blue", font = ("Time New Roman", 12, "bold"),command=saveList,width = 100, height = 2)
    bsave.pack(fill=X, padx=15, pady=5)
    bclear = Button(window, text = "Clear",
                    bg = "royal blue", font = ("Time New Roman", 12, "bold"),command=clearList,width = 100, height = 2)
    bclear.pack(fill=X, padx=15, pady=5)
    bload = Button(window, text = "Upload",
                   bg = "light sea green", font = ("Time New Roman", 12, "bold"),command=addSource,width = 100, height = 2)
...
def addSource():
    ...
    filename = askopenfilename(
        parent = wind,
        title = 'Choose a file',
        initialdir = os.path.expanduser(u'~/'),
